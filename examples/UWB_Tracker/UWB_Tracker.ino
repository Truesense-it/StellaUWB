 ...
 *
 * Sets up the Arduino Stella as a Two-Way Ranging Initiator/Controller and
 * prints the measured distance to its peer.
 *
 * Hardware: 2 boards.
 *   This board  : UWB_Tracker   (own MAC 0x2222, peer 0x1111)
 *   Second board: UWB_Controlee (own MAC 0x1111, peer 0x2222)
 *
...
void setup() {
  ...
  //To run this board as a Responder/Controlee instead, construct the session as:
  //  UWBTracker myTracker(0x11223344, dstAddr, srcAddr,
  //                       uwb::DeviceRole::RESPONDER, uwb::DeviceType::CONTROLEE);
